...
console.log('[Media Downloader] TikTok content script loaded');
...
window.addEventListener('message', function (event) {
  ...
  if (event.data.type === 'CHUNK_INTERCEPTED' && event.data.source === 'media-downloader-injected') {
    console.log('[Media Downloader] Received chunk data from TikTok:', event.data.data);
  ...
  console.log('[Media Downloader] Received media data from TikTok:', event.data.data);
